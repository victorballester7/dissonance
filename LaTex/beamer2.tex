...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includestandalone[mode=image,width=5.5cm]{Imatges_main/model2}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includestandalone[mode=image,width=9cm]{Imatges_main/complex2}
    \end{figure}
\end{frame}
\begin{frame}{Aclariment}
    ...
    \begin{figure}[ht]
        \centering
        \subfloat[Sons simples]{\includestandalone[mode=image,width=5.9cm]{Imatges_beamer2/simple440}}
        \subfloat[Sons complexos]{\includestandalone[mode=image,width=5.9cm]{Imatges_beamer2/complex440}}
    \end{figure}
\end{frame}
