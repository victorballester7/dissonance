...
\begin{document}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \node [anchor=west,color=orange,font=\bf] (freq) at (axis cs:0.99,0.2){225 Hz}; 
            \node (disso) at (axis cs:1.023,0.0003){};
            \draw[->,color=orange,very thick,dashed](freq)--(disso);
            \addplot [mark=oplus*,mark size=2pt,orange] coordinates {(1.023,0.0003)};
